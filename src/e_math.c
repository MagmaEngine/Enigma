...
void e_flatten2f(float *output, float *pos, float *normal)
{
	float f;
	f = pos[0] * normal[0] + pos[1] * normal[1];
...
void e_project2f(float *output, float *plane_pos, float *normal, float *pos, float *vector)
{
	float f;
...
void e_flatten3f(float *output, float *pos, float *normal)
{
	float f;
	f = pos[0] * normal[0] + pos[1] * normal[1] + pos[2] * normal[2];
	output[0] = pos[0] - normal[0] * f;
...
void e_project3f(float *output, float *plane_pos, float *normal, float *pos, float *vector)
{
	float f;
...
void e_cross2d(double *output, double *a)
{
	output[0] = a[1];
	output[1] = -a[0];
}

void e_surface_cross2d(double *output, double *a, double *subtract)
{
	output[0] = a[1] - subtract[1];
	output[1] = subtract[0] - a[0];
}
...
void e_flatten2d(double *output, double *pos, double *normal)
{
	double f;
	f = pos[0] * normal[0] + pos[1] * normal[1];
	output[0] = pos[0] - normal[0] * f;
...
void e_project2d(double *output, double *plane_pos, double *normal, double *pos, double *vector)
{
	double f;
	f = normal[0] * (plane_pos[0] - pos[0]) + normal[1] * (plane_pos[1] - pos[1]);
	f /= normal[0] * vector[0] + normal[1] * vector[1];
...
void e_surface_cross3d(double *output, double *a, double *b, double *subtract)
{
	double a2[3], b2[3];
	a2[0] = a[0] - subtract[0];
	a2[1] = a[1] - subtract[1];
...
void e_flatten3d(double *output, double *pos, double *normal)
{
	double f;
	f = pos[0] * normal[0] + pos[1] * normal[1] + pos[2] * normal[2];
	output[0] = pos[0] - normal[0] * f;
...
void e_project3d(double *output, double *plane_pos, double *normal, double *pos, double *vector)
{
	double f;
	f = normal[0] * (plane_pos[0] - pos[0]) + normal[1] * (plane_pos[1] - pos[1]) + normal[2] * (plane_pos[2] - pos[2]);
	f /= normal[0] * vector[0] + normal[1] * vector[1] + normal[2] * vector[2];
